    ...
    this.state = {
      ...
      desc: [
        ...
        },
        {
          ...
          jobdesk: [
            <>
              ...
              <li>Sharing the product knowledge: how is it better than others?</li>
        ...
        },
        {
          ...
          jobdesk: [
            <>
              <li>Selling ideas, services, and product in residential neighbourhoods and places of business (Canvassing)</li>
              ...
              <li>Attending and represent the company at marketing exhibition or events</li>
            </>,
          ],
          year: "2017-2017",
        },
        {
          ...
          jobdesk: [
            <>
              ...
              <li>Follow up with a calls, and set up for an Appointment Meeting</li>
              <li>Selling ideas, services, and product in residential neighbourhoods and places of business (canvassing)</li>
              <li>Presenting the company’s product knowledge</li>
              <li>Following the clients’ need up</li>
              <li>Negotiate the terms of an agreement and close sales (closing)</li>
            </>,
          ],
          year: "2014-2015",
        },
        {
          ...
          jobdesk: [
            <>
              <li>Maintaining relationships with current clients, build and maintain relationships with new clients</li>
              <li>Looking for under 17th years old potential customers</li>
              <li>Selling ideas, services, and product in residential neighbourhoods and places of business (canvassing)</li>
              <li>Presenting the company’s product knowledge</li>
              <li>Following up with the clients’ needs</li>
              <li>Negotiating the terms of an agreement and close sales (closing)</li>
            </>,
          ],
          year: "2013-2014",
        },
